...
import { FaGasPump, FaRoute, FaMoneyBillWave, FaCalculator } from 'react-icons/fa';
...
const CalculadoraPage = () => {
  ...
  const calcularEstimativas = () => {
    ...
    if (isNaN(precoGas) || isNaN(kmL) || isNaN(meta) || isNaN(valorKm)) {
      return;
    }
          ...
          {resultados ? (
            <div className="space-y-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="text-lg font-medium text-gray-900 mb-2">Distância e Combustível</h3>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="text-lg font-medium text-gray-900 mb-2">Corridas e Ganhos</h3>
                <div className="space-y-2">
                  <p className="text-gray-700">
